...
class SolidQ8(Quadrangle9):
    """ A 2D 8-noded quadrangular element for continuum mechanics
    ...
    def __init__(self,node_list=[],tag=1):  
        ...
        """      
        Quadrangle9.__init__(self,node_list,tag)
	self.nodes = NodeGroup(self.nodes.node_list[:8])
        self.elem_type = 'Q8'
# =============================================================================
#         A COMPLETER
# =============================================================================
